...
const Footer: React.FC = () => {
  return (
    <footer className="bg-black border-t border-gray-800 text-gray-300 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-semibold ml-2 text-white">Cartesia</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/" className="hover:text-white">Sonic</Link></li>
                <li><Link to="/" className="hover:text-white">Deployments</Link></li>
                <li><Link to="/" className="hover:text-white">Products</Link></li>
                <li><Link to="/" className="hover:text-white">Voice Changer</Link></li>
                <li><Link to="/" className="hover:text-white">Voice Cloning</Link></li>
                <li><Link to="/" className="hover:text-white">Text To Speech</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/" className="hover:text-white">Customers</Link></li>
              </ul>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-gray-800">
          ...
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Cartesia. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
